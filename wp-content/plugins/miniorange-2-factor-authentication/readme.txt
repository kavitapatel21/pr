...
* [Microsoft Authenticator](https://developers.miniorange.com/docs/security/wordpress/wp-security/microsoft-authenticator)
...
* [RBA & Trusted Devices Management Add-on](https://developers.miniorange.com/docs/security/wordpress/wp-security/remember-my-device) Features for two-factor authentication ( WP 2FA/OTP Login )
...
* [Short Codes Add-on](https://plugins.miniorange.com/wordpress-two-factor-authentication-setup-guides#) Features for two-factor authentication ( 2FA / MFA )
