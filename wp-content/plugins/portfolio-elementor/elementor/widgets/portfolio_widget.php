...
class ELPT_Portfolio_Widget extends Widget_Base
{
    ...
    protected function render()
    {
		...
		<?php 
        echo  do_shortcode( '[powerfolio hover="' . $settings['hover'] . '" postsperpage="' . $settings['postsperpage'] . '" showfilter="' . $settings['showfilter'] . '" showallbtn="' . $settings['showallbtn'] . '" tax_text="' . $settings['tax_text'] . '" style="' . $settings['style'] . '" margin="' . $settings['margin'] . '" columns="' . $settings['columns'] . '" linkto="' . $settings['linkto'] . '"]' ) ;
        ?>		
