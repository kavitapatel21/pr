...
class OutputCSS_Body extends AdminSettingsModel {
	...
	public function jltwp_adminify_output_body_styles() {
		...
		$button_primary_color   = ! empty( $this->options['admin_general_button_color']['primary_color'] ) ? esc_attr( $this->options['admin_general_button_color']['primary_color'] ) : '#0347FF';
