...
class AdminifyPromo
{
    ...
    public function jltwp_adminify_latest_update_details()
    {
        ...
        $jltwp_adminify_changelog_message = sprintf(
            ...
            // %3$s
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Style and Script Tags missing issue fixed </span><br>', 'adminify' ),
            __( '<span class="dashicons dashicons-yes"></span> <span class="adminify-changes-list"> Schedule Posts style issue fixed </span><br>', 'adminify' ),
