...
$jltwp_adminify_plugin_data = get_file_data( __FILE__, [
    'Version'     => 'Version',
    ...
    if ( !function_exists( 'jltwp_adminify' ) ) {
        ...
        function jltwp_adminify()
        {
            ...
            if ( !isset( $jltwp_adminify ) ) {
                ...
                $jltwp_adminify = fs_dynamic_init( [
                    'id'              => '7829',
                    'slug'            => 'adminify',
...
if ( class_exists( '\\WPAdminify\\WP_Adminify' ) ) {
    register_activation_hook( WP_ADMINIFY_FILE, [ '\\WPAdminify\\WP_Adminify', 'jltwp_adminify_activation_hook' ] );
    register_deactivation_hook( WP_ADMINIFY_FILE, [ '\\WPAdminify\\WP_Adminify', 'jltwp_adminify_deactivation_hook' ] );
}
