<div id="box_1_e">
    <h2 class="nwallet_set_title">
        ...
        <strong><?php echo esc_html__('Extra Field', 'nirweb-support'); ?> </strong>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Enabled Extra Field', 'nirweb-support'); ?> </strong>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Name Extra Field', 'nirweb-support'); ?> </strong>
        </label>
    ...
    <div class="uk-margin">
        <label class="uk-form-label"
               for="select_page_ticket"><strong><?php echo esc_html__('Type Extra Field', 'nirweb-support'); ?> </strong></label>
        <div uk-form-custom="target: > * > span:first-child" class="uk-form-custom">
            <select disabled>
