<div id="box_2_p">
    <h2 class="nwallet_set_title">
        ...
        <strong><?php echo esc_html__('Basic Field', 'nirweb-support') ?></strong>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Disabled product field', 'nirweb-support'); ?></strong>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Disabled priority field', 'nirweb-support'); ?></strong>
