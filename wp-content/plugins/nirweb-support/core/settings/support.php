<div id="box_2">
    <h2 class="nwallet_set_title">
        ...
        <strong><?php echo esc_html__('Support notification', 'nirweb-support') ?></strong>
    </h2>

    <div class="uk-margin">
        <label class="uk-form-label"
               for="active_send_mail_to_poshtiban"><strong><?php echo esc_html__('Send Email To Support', 'nirweb-support'); ?></strong></label>
    ...
    <hr>
    <h3><?php echo esc_html__('Send Ticket', 'nirweb-support'); ?></h3>
    <div class="uk-margin">
        <label class="uk-form-label"
    ...
    <hr>
    <h3><?php echo esc_html__('Answer Ticket', 'nirweb-support'); ?></h3>
    <div class="uk-margin">
        <label class="uk-form-label"
