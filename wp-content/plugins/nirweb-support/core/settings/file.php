<div id="box_5">
    ...
    <div class="uk-margin">
        <label class="uk-form-label"
               for="size_of_file_wpyartik"><?= esc_html__('Upload volume in MB', 'nirweb-support') ?></label>
    ...
    <div class="uk-margin">
        <label class="uk-form-label"
               for="size_of_file_wpyartik"><?= esc_html__('Authorized file extensions', 'nirweb-support') ?></label>
        <div class="uk-form-controls">
