<div id="box_1_p">
    <h2 class="nwallet_set_title">
        ...
        <strong><?php echo esc_html__('Payment Link', 'nirweb-support') ?></strong>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('View list of paid links', 'nirweb-support'); ?></strong>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Explanation of payment gateway', 'nirweb-support'); ?></strong>
         </label>
    ...
    <div class="uk-margin">
        <label class="uk-form-label"
               for="select_page_ticket"><strong><?php echo esc_html__('Thanks page after payment', 'nirweb-support'); ?></strong></label>
        <div uk-form-custom="target: > * > span:first-child" class="uk-form-custom">
            <select disabled>
