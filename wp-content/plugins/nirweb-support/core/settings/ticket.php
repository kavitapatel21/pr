...
<div id="box_4">
    ...
    <div class="uk-margin">
        <label class="uk-form-label"
               for="require_procut_user_wpyar"><strong><?php echo esc_html__('Select Product Required', 'nirweb-support'); ?></strong></label>
    ...
    <div class="uk-margin">
        <label class="uk-form-label"
               for="poshtiban_text_email_send"><strong><?php echo esc_html__('Text above the Send Ticket', 'nirweb-support'); ?></strong></label>
