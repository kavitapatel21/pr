<div id="telegram">
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Send Message To Telegram', 'nirweb-support'); ?></strong>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Notice After sending ticket', 'nirweb-support'); ?></strong>
        </label>
    ...
    <div class="uk-margin">
        ...
        <label class="uk-form-label pro_ver"
               for="select_page_ticket"><strong><?php echo esc_html__('Notice After sending reply', 'nirweb-support'); ?></strong>
        </label>
