<div id="box_3">
    ...
    <h2 class="nwallet_set_title">
        ...
        <strong><?php echo esc_html__('Send Email To User', 'nirweb-support') ?></strong>
    </h2>

    <div class="uk-margin">
        <label class="uk-form-label"
               for="active_send_mail_to_user"><strong><?php echo esc_html__('Send Email To User', 'nirweb-support'); ?></strong></label>
