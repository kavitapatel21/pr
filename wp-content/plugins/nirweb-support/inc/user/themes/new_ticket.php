<div class="nirweb_ticket_base">
	...
	<div class="top_box_send_ticket">
		<div class="head_send_ticket_wpyar">
			...
			<a href=" <?php echo esc_url_raw( $page ); ?> "  class="btn btn_back_wpyt"><?php echo esc_html__( 'Back To List Tickets', 'nirweb-support' ); ?></a>
		</div>
	...
	<form class="form__global__ticket_new shadow__wpys" id="send_ticket_form" method="post" enctype="multipart/form-data" <?php if ( $faq ) { echo "style='display:none'"; } ?> >
		...
		<div class="row_nirweb_ticket_send">
			<div class="w-50">
				<label for="nirweb_ticket_frm_subject_send_ticket_user"><?php echo esc_html__( 'Enter subject please *', 'nirweb-support' ); ?></label>
			...
			<div class="w-50">
				<div class="department_form_user_send">
					<label for="nirweb_ticket_frm_department_send_ticket_user"><?php echo esc_html__( 'Select department please *', 'nirweb-support' ); ?></label>
		...
		<div class="row_nirweb_ticket_send">
			<div class="w-100">
				<label><?php echo esc_html__( 'Enter Message', 'nirweb-support' ); ?></label>
		...
		<div class="send_reset_form">
			<div class="base_loarder">
				...
				<p><?php echo esc_html__( 'Send Request ...', 'nirweb-support' ); ?></p>
			</div>
			...
			<button data-fileurl="" type="submit" class="btn btn-primary text-white"
				...
				<?php echo esc_html__( 'Send Ticket', 'nirweb-support' ); ?>
			</button>
			...
			if (<?php echo $shart; ?>) {
				...
				jQuery.ajax({
					...
					success: function (response) {
						...
						jQuery('.base_loarder').css('display', 'none');
						alert_success("<?php echo esc_html__( 'Send Ticket Success', 'nirweb-support' ); ?>");
						setTimeout(() => {
							location.reload();
						}, 3000);
