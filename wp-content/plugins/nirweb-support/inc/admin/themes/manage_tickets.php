...
if ( isset($_GET['action']) && $_GET['action'] == 'edit' ) {
	...
	$tabs = array(
		'all_ticket'      => esc_html__( 'All Ticket', 'nirweb-support' ) . '(' . nirweb_ticket_count_all_ticket() . ')',
		'new_ticket'      => esc_html__( 'New', 'nirweb-support' ) . '(' . nirweb_ticket_count_new_ticket() . ')',
		'process_ticket'  => esc_html__( 'InProgress', 'nirweb-support' ) . '(' . nirweb_ticket_count_process_ticket() . ')',
...
<div class="war__list_ticket_page">
	...
	<div class="ajax_search">
		<input class="form-control" id="serch_support_wpy" type="text"
			placeholder="<?php echo esc_html__( 'Enter ID or subject ticket', 'nirweb-support' ); ?>">
