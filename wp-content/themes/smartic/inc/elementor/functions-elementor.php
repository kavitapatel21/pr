<?php
if ( ! function_exists( 'smartic_elementor_get_render_attribute_string' ) ) {
	function smartic_elementor_get_render_attribute_string($element, $obj) {
		return $obj->get_render_attribute_string($element);
	}
}
if ( ! function_exists( 'smartic_elementor_parse_text_editor' ) ) {
	function smartic_elementor_parse_text_editor( $content, $obj ) {
...
if ( ! function_exists( 'smartic_elementor_get_strftime' ) ) {
	function smartic_elementor_get_strftime( $instance, $obj ) {
		$string = '';
