					...
					<?php foreach ( $settings['testimonials'] as $testimonial ): ?>
                        <div <?php echo smartic_elementor_get_render_attribute_string( 'item', $this ); // WPCS: XSS ok. ?>>
                            <div class="inner">
                                ...
                                <?php elseif($settings['testimonial_style'] == 'style4'): ?>
                                ...
                                <?php
                                if($settings['testimonial_rating_position'] == 'top') {
                                ...
                                <div class="testimonial-content">
                                    ...
                                    <?php if($settings['testimonial_style'] != 'style5'): ?>
                                        ...
                                        <?php if ($settings['testimonial_style'] == 'style5'):?>
                                            <?php $this->render_image( $settings, $testimonial ); ?>
                                        <?php endif;?>
                                        <?php if ($settings['testimonial_style'] != 'style2' && $settings['testimonial_style'] != 'style3' &&  $settings['testimonial_style'] != 'style4'):?>
                                            <?php $this->render_detail($testimonial);?>
                                        <?php endif;?>
                                    <?php endif;?>
                                    <?php if($settings['testimonial_style'] == 'style5'): ?>
