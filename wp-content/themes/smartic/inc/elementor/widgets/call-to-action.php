...
class Smartic_Call_To_Action extends Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        ?>
        <<?php echo esc_html($wrapper_tag) . ' ' . smartic_elementor_get_render_attribute_string( 'wrapper', $this ); ?> class="elementor-cta--skin-cover elementor-cta elementor-smartic-banner">
        <?php if ( $print_bg ) : ?>
            <div class="elementor-cta__bg-wrapper">
                <div class="elementor-cta__bg elementor-bg" <?php echo smartic_elementor_get_render_attribute_string( 'background_image', $this ); ?>></div>
        ...
        <?php if ( $print_content ) : ?>
            ...
            <?php if ( 'image' === $settings['graphic_element'] && ! empty( $settings['graphic_image']['url'] ) ) : ?>
                <div <?php echo smartic_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                ...
                <div <?php echo smartic_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                    <div class="elementor-icon">
                        <?php if ( $is_new || $migrated ) :
                            ...
                            <i <?php echo smartic_elementor_get_render_attribute_string( 'icon', $this ); ?>></i>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $settings['subtitle'] ) ) : ?>
                <div <?php echo smartic_elementor_get_render_attribute_string( 'subtitle', $this ); ?>>
                    <?php printf('%s', $settings['subtitle']); ?>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $settings['title'] ) ) : ?>
                <<?php echo esc_html($title_tag) . ' ' . smartic_elementor_get_render_attribute_string( 'title', $this ); ?>>
                <?php printf('%s', $settings['title']); ?>
                </<?php echo esc_html($title_tag); ?>>
            <?php endif; ?>

            <?php if ( ! empty( $settings['description'] ) ) : ?>
                <div <?php echo smartic_elementor_get_render_attribute_string( 'description', $this ); ?>>
            ...
            <div class="elementor-cta__button-wrapper elementor-cta__content-item elementor-content-item <?php echo esc_attr($animation_class); ?>">
                <<?php echo esc_html($button_tag) . ' ' . smartic_elementor_get_render_attribute_string( 'button', $this ); ?>>
                <span>
