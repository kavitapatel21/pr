                        ...
                        <div <?php echo smartic_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . smartic_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
                                ...
                                if ($item['type_brand'] == 'image') {
                                    ...
                                    if ($is_new || $migrated) {
                                        ...
                                        <i <?php echo smartic_elementor_get_render_attribute_string('icon', $this); // WPCS: XSS ok. ?>></i>
                                        <?php
                                    }
                                }
                                if (!empty($item['link'])) {
