    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-media-carousel__img img' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
                            ...
                            <div class="elementor-media-carousel__content">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    if (!empty($item['title_text'])){
                                        echo '<div class="title"><a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . smartic_elementor_get_render_attribute_string('title-link', $this) . ' title="' . esc_attr($item['title_text']) . '">'.esc_html($item['title_text']).'</a></div>';
                                    }
