...
class Smartic_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Box', 'smartic');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'smartic'),
        ...
        $this->add_control(
            'facebook',
            [
                'label'       => esc_html__('Facebook', 'smartic'),
                'placeholder' => esc_html__('https://www.facebook.com/opalwordpress', 'smartic'),
        ...
        $this->add_control(
            'twitter',
            [
                'label'       => esc_html__('Twitter', 'smartic'),
                'placeholder' => esc_html__('https://twitter.com/opalwordpress', 'smartic'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => esc_html__('Youtube', 'smartic'),
                'placeholder' => esc_html__('https://www.youtube.com/user/WPOpalTheme', 'smartic'),
        ...
        $this->add_control(
            'google',
            [
                'label'       => esc_html__('Google', 'smartic'),
                'placeholder' => esc_html__('https://plus.google.com/u/0/+WPOpal', 'smartic'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'smartic'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                        ...
                        <?php if (!empty($settings[$key])) : ?>
                            <li class="social">
                                <a href="<?php echo esc_url($settings[$key]) ?>">
                                    <i class="smartic-icon-<?php echo esc_attr($social); ?>"></i>
                                </a>
                            </li>
                        <?php endif; ?>
                    <?php endforeach; ?>
...
$widgets_manager->register(new Smartic_Elementor_Team_Box());
