...
class Smartic_Slides_Carousel extends Elementor\Widget_Base
{
    ...
    protected function render()
    {
        ...
        // Item
        $this->add_render_attribute( 'item', 'class', 'swiper-slide elementor-slides-item' );
        ?>
                ...
                <div class="swiper-container js-swiper-container">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <?php foreach ($settings['images_list'] as $item) : ?>
                            <div <?php echo smartic_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                                    ...
                                    if (!empty($item['image_item']['url'])) : ?>
                                        <div class="elementor-slides-carousel__img">
                                            ...
                                            if (!empty($item['link']['url'])) {
                                                ...
                                                echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . smartic_elementor_get_render_attribute_string('button-link', $this) . '>';
                                            }
                                    ...
                                    <div class="elementor-slides-item__content">
                                        ...
                                        if (!empty($item['link']['url'])) {
                                            ...
                                            if (!empty($item['title_item'])){
                                                echo '<h4 class="slides-item-title"><a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . smartic_elementor_get_render_attribute_string('button-link', $this) . '>'.esc_html($item['title_item']).'</a></h4>';
                                            }
                                        }else{
                                            if(!empty($item['title_item'])){
