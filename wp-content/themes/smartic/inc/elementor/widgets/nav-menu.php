...
class OSF_Elementor_Nav_Menu extends Elementor\Widget_Base{
    ...
    {
        return 'smartic-nav-menu';
    }

    public function get_title()
    {
        return esc_html__('Smartic Nav Menu', 'smartic');
    }
    ...
    protected function register_controls()
    {
        ...
        if ( ! empty( $menus ) ) {
            $this->add_control(
                ...
                [
                    ...
                    'save_default' => true,
                    'separator' => 'after',
                    'description' => sprintf(__( 'Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'smartic' ), admin_url( 'nav-menus.php' ) ),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => '<strong>' . esc_html__( 'There are no menus in your site.', 'smartic' ) . '</strong><br>' . sprintf(__( 'Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'smartic' ), admin_url( 'nav-menus.php?action=edit&menu=0' ) ),
                    'separator' => 'after',
        ...
        $this->add_control(
            'menu_title_color',
            [
                'label'     => esc_html__( 'Color Menu', 'smartic' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Color Sub Menu', 'smartic' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'sub_menu_color',
            [
                'label'     => esc_html__( 'Background Dropdown', 'smartic' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__( 'Background Item', 'smartic' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
    ...
    protected function render()
    {
        ...
        <div <?php echo smartic_elementor_get_render_attribute_string('wrapper', $this);?>>
            <nav class="main-navigation" role="navigation" aria-label="<?php esc_attr_e('Primary Navigation', 'smartic'); ?>">
