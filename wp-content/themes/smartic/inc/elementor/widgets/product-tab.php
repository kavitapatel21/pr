 ...
 * @since 1.0.0
 */
class Smartic_Elementor_Products_Tabs extends Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products Tabs', 'smartic' );
	}
	...
	public function get_script_depends() {
		return [ 'smartic-elementor-product-tab', 'slick' ];
	}
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'tab_title',
			[
				'label'       => esc_html__( 'Tab Title', 'smartic' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( '#Product Tab', 'smartic' ),
				'placeholder' => esc_html__( 'Product Tab Title', 'smartic' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'tab_title' => esc_html__( '#Product Tab 1', 'smartic' ),
					],
					[
						'tab_title' => esc_html__( '#Product Tab 2', 'smartic' ),
					]
				],
		...
		$this->start_controls_section(
			'section_product',
			[
				'label' => esc_html__( 'Product', 'smartic' ),
			]
		);
		$this->add_responsive_control(
			'product_gutter',
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Header', 'smartic' ),
		...
		$this->add_responsive_control(
			'align_items',
			[
				'label'        => esc_html__( 'Align', 'smartic' ),
		...
		$this->add_responsive_control(
			'header_margin',
			[
				'label'      => esc_html__( 'Spacing Between Item', 'smartic' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->start_controls_tab(
			'tab_title_active',
			[
				'label' => esc_html__( 'Active', 'smartic' ),
			]
		);
        ...
        <div class="elementor-tabs" role="tablist">
            <div class="elementor-tabs-wrapper">
				...
				foreach ( $tabs as $index => $item ) :
					...
					?>
                    <div <?php echo smartic_elementor_get_render_attribute_string( $tab_title_setting_key, $this ); // WPCS: XSS ok.
					?>><?php echo esc_html( $item['tab_title'] ); ?></div>
				<?php endforeach; ?>
            </div>
            <div <?php echo smartic_elementor_get_render_attribute_string( 'data-carousel', $this ); // WPCS: XSS ok.
			?>>
				<?php
				foreach ( $tabs as $index => $item ) :
					$tab_count = $index + 1;
					...
					?>
                    <div <?php echo smartic_elementor_get_render_attribute_string( $tab_content_setting_key, $this ); // WPCS: XSS ok.
					?>>
...
$widgets_manager->register( new Smartic_Elementor_Products_Tabs() );
