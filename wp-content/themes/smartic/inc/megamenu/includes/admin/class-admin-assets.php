...
class Smartic_Admin_Megamenu_Assets {
	...
	public static function add_scripts_editor() {
		...
		if ( isset( $_REQUEST['smartic-menu-editable'] ) && $_REQUEST['smartic-menu-editable'] ) {
			wp_register_script( 'smartic-elementor-menu', get_template_directory_uri() . '/inc/megamenu/assets/js/editor.js', [], $smartic_version );
			wp_enqueue_script( 'smartic-elementor-menu' );
		}
	}
